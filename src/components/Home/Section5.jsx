        ...
        <Container>
          <Row className="align-items-center justify-content-center">
            <Col lg={6} className="text-center text-lg-start mb-5 mb-lg-0">
              ...
              <h2>Save up to 20%</h2>
              <p>
                Get our mobile app today and save up to 20% on your next burger
                order!
              </p>
              <Link to="https://play.google.com/" target="_blank">
                <img
                  src={StoreGoogle}
                  alt="google play app download button"
                  className="me-3 img-fluid app-btn"
                />
              </Link>
